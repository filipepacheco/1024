...
int moveBloco(char key, Bloco matriz[][6], int TAM, Jogador *usuario, int *flag); // Função principal que é executada num while pegando entrada do usuário e movendo o tabuleiro
